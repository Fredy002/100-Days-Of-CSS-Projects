...
| [36](https://github.com/Fredy002/100-Days-Of-CSS-Projects/tree/day_31-40/day_36) | Tabbed Interface with Material Icons: This HTML and CSS code creates a modern tabbed interface in a square container with a dark theme. It features four tabs at the top, each with Material Design icons for visibility, chat, notifications, and settings, and a search icon on the right. Selecting a tab displays corresponding content in a white area below. The design is clean, with tabs highlighting in blue when active, suitable for dashboards or settings menus. | ![day_36] |
