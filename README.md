...
| [40](https://github.com/Fredy002/100-Days-Of-CSS-Projects/tree/day_31-40/day_40) | Interactive Image Gallery: This HTML, CSS, and JavaScript code creates an interactive image gallery. The gallery features a grid of nine images. Each image, when clicked, animates to a larger scale, providing a focused view, and then reverts to its original size upon a second click. The transformation of each image is smooth, with animations defined for both enlarging and shrinking effects. The positioning of the images is set to different corners of the container for each picture, ensuring a varied and dynamic viewing experience. This setup is ideal for web pages needing an engaging and responsive gallery feature. | ![day_40](https://github.com/Fredy002/100-Days-Of-CSS-Projects/assets/104151778/5153f665-ef14-46d7-a65d-dd04a11a3aec) |
